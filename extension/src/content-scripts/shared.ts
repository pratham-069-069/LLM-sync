...
      ];
    ...
    case 'Gemini': // ✨ NEWLY ADDED
      return [
        'div.ql-editor[contenteditable="true"]', // Best selector from screenshot
        'div[contenteditable="true"][aria-label="Enter a prompt here"]', // Good fallback
        'div[contenteditable="true"][role="textbox"]'
      ];
    
    default:
...
      ];
    ...
    case 'Gemini': // ✨ NEWLY ADDED
      return [
        'button[aria-label="Send message"]', // Best selector (inferred)
...
const clickSendButton = (button: HTMLButtonElement, platform: string) => {
